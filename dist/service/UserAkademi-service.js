...
const Util_service_1 = require("./busines/Util-service");
class UserAkademiService {
    ...
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userCek = yield Util_service_1.UtilService.getUser(request.username);
            if (!userCek) {
                throw new response_error_1.ResponseError(404, "Username not found");
            }
            const cekAda = yield this.getUsernameAndAkademi(request.username, request.kode_akademi);
            if (cekAda.length > 0) {
                throw new response_error_1.ResponseError(404, "Username dan Akademi sudah ada");
            }
    ...
    static getUsername(user, username) {
        return __awaiter(this, void 0, void 0, function* () {
            const userAkademi = yield database_1.prismaClient.userAkademi.findMany({
                where: {
                    username: username,
                    create_by: user.username
                }
    ...
    static getKode_akademi(user, kode_akademi) {
        return __awaiter(this, void 0, void 0, function* () {
            const userAkademi = yield database_1.prismaClient.userAkademi.findMany({
                where: {
    ...
    //=====================
    static getUsernameAndAkademi(username, akademi_kode) {
        return __awaiter(this, void 0, void 0, function* () {
            const userAkademi = yield database_1.prismaClient.userAkademi.findMany({
                where: {
                    username: username,
