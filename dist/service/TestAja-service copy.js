...
class TestAjaService {
    ...
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //unutk tanggal formatnya adalah YYYY-MM-DD //"2025-01-01"
            // const tglCreate = new Date()
            // console.log("tgl create "+tglCreate)
            //request.tglaja = new Date(tglaja)
            const record = Object.assign(Object.assign(Object.assign({}, createRequest), { create_by: user.name }), { create_at: new Date() });
            // console.log("datetime------>>>> :: "+record.create_at)
    ...
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log("udate :::;--->" + JSON.stringify(record));
