...
exports.JobFamilyService = void 0;
const database_1 = require("../application/database");
const response_error_1 = require("../error/response-error");
const JobFamily_model_1 = require("../model/JobFamily-model");
const JobFamily_validation_1 = require("../validation/JobFamily-validation");
const validation_1 = require("../validation/validation");
class JobFamilyService {
    //CREATE 
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const createRequest = validation_1.Validation.validate(JobFamily_validation_1.JobFamilyValidation.CREATE, request);
            //belum ada validasi bila tidak boleh sama (uniq) dalam kolom
            //Ubah dulu format datenya spt ini ::2025-03-01T00:00:00.000Z
            const totalkodeUniq = yield database_1.prismaClient.jobFamily.count({
                where: {
            ...
            const jobFamily = yield database_1.prismaClient.jobFamily.create({
                data: record
            });
            return (0, JobFamily_model_1.toJobFamilyResponse)(jobFamily);
        });
    }
    // CEK EXIST
    //function untuk getJobFamily biar bisa dipakai berulang
    static checkJobFamilyMustexist(jobFamilyId) {
        return __awaiter(this, void 0, void 0, function* () {
            const jobFamily = yield database_1.prismaClient.jobFamily.findFirst({
                where: {
                    id: jobFamilyId,
                    //create_by: user.username
                }
            ...
            if (!jobFamily) {
                throw new response_error_1.ResponseError(404, "JobFamily not found");
            }
            return jobFamily;
        });
    }
    ...
    static get(user, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const jobFamily = yield this.checkJobFamilyMustexist(id);
            return (0, JobFamily_model_1.toJobFamilyResponse)(jobFamily);
        });
    }
    // UPDATE by Id
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_1.Validation.validate(JobFamily_validation_1.JobFamilyValidation.UPDATE, request);
            ...
            yield this.checkJobFamilyMustexist(request.id);
            const jobFamily = yield database_1.prismaClient.jobFamily.update({
                where: {
                    id: updateRequest.id,
                    create_by: user.username
                },
    ...
    static remove(user, id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.checkJobFamilyMustexist(id);
            const jobFamily = yield database_1.prismaClient.jobFamily.delete({
                where: {
                    id: id,
                    create_by: user.username
                }
    ...
    static search(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchRequest = validation_1.Validation.validate(JobFamily_validation_1.JobFamilyValidation.SEARCH, request);
            ...
            const jobFamilys = yield database_1.prismaClient.jobFamily.findMany({
                where: {
            ...
            const total = yield database_1.prismaClient.jobFamily.count({
                where: {
                    create_by: user.username,
                    AND: filters
                },
            ...
            return {
                data: jobFamilys.map(jobFamily => (0, JobFamily_model_1.toJobFamilyResponse)(jobFamily)),
                paging: {
    ...
    static getKode(user, kode) {
        return __awaiter(this, void 0, void 0, function* () {
            const jobFamily = yield database_1.prismaClient.jobFamily.findMany({
                where: {
                    kode: kode,
                    create_by: user.username
                }
    ...
    static getDeskripsi(user, deskripsi) {
        return __awaiter(this, void 0, void 0, function* () {
            const jobFamily = yield database_1.prismaClient.jobFamily.findMany({
                where: {
                    deskripsi: deskripsi,
...
exports.JobFamilyService = JobFamilyService;
