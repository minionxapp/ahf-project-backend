"use strict";
//CREATE validation Divisi-validation.ts
Object.defineProperty(exports, "__esModule", { value: true });
exports.DivisiValidation = void 0;
const zod_1 = require("zod");
class DivisiValidation {
}
exports.DivisiValidation = DivisiValidation;
DivisiValidation.CREATE = zod_1.z.object({
...
//UPDATE validation
DivisiValidation.UPDATE = zod_1.z.object({
    id: zod_1.z.string(),
    kode: zod_1.z.string().min(1).max(30),
    nama: zod_1.z.string().min(1).max(100),
    aktive: zod_1.z.string().min(1).max(30),
...
//SEARCH validation
DivisiValidation.SEARCH = zod_1.z.object({
